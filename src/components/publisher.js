...
class Publisher extends React.Component {
    constructor(props) {
      ...
      getRatePerImpression = async () => {
        const rate = (await Utils.contract
          .getRatePerImpression()
          .call()).toNumber();
        ...
        return (
          ...
          >
            Publisher Dashboard
              ...
              <br />
              <br />
              <button onClick={this.createPublisher}>Create Publisher</button>
              <br />
              <br />
              <input
                type="number"
                ...
                required
              />
              <button onClick={this.handleGetPublisherDetails}>
                Publisher Details
              </button>
              <br />
              <br />
              ...
              <div>
                <h4>
                  Creator Address: {this.state.publisherDetails.creatorAddress}
                </h4>
                <h4>
                  Impressions: {this.state.publisherDetails.impressions.toString()}
                </h4>
                <h4>Earnings: {this.state.publisherDetails.earnings.toString()}</h4>
                <br />
                <input
                  type="number"
                  name="publisherId"
                  ...
                  required
                />
                <button onClick={this.handleWithdrawEarnings}>
                  Withdraw Earnings
                </button><br /><br />
