            ...
            Advertiser Dashboard
              ...
              <form onSubmit={this.handleSubmit}>
                ...
                <input
                  type="number"
                  name="budget"
                  value={this.state.adForm.budget} // Set value directly from state
                  placeholder="Budget"
                  required
                />
    
                <button type="submit">Create Ad</button><br /><br /><br />
              </form>
    
              
              <h4>Current Rate Per Impression: {this.state.ratePerImpression}</h4><br /><br />
